    ...
    return (
        ...
        >   
            <FormControl>
                ...
                <Input id="date" name="date" aria-describedby="date-desc"></Input>
            ...
            <FormControl>
                ...
                <Input id="avg" name="avg" aria-describedby="avg-desc"></Input>
            ...
            <FormControl>
                ...
                <Input id="buy-100m" name="buy-100m" aria-describedby="buy-100m-desc"></Input>
            ...
            <FormControl>
                ...
                <Input id="buy-1b" name="buy-1b" aria-describedby="buy-1b-desc"></Input>
            ...
            <FormControl>
                ...
                <Input id="buy-10b" name="buy-10b" aria-describedby="buy-10b-desc"></Input>
            ...
            <FormControl>
                ...
                <Input id="sell-100m" name="sell-100m" aria-describedby="sell-100m-desc"></Input>
            ...
            <FormControl>
                ...
                <Input id="sell-1b" name="sell-1b" aria-describedby="sell-1b-desc"></Input>
            ...
            <FormControl>
                ...
                <Input id="sell-10b" name="sell-10b" aria-describedby="sell-10b-desc"></Input>
